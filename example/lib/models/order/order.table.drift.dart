...
import 'package:example/models/order/order.dart' as i1;
import 'package:example/models/order/order.table.drift.dart' as i2;
import 'package:example/models/order/order.table.dart' as i3;
...
class _$OrderInsertable implements i0.Insertable<i1.Order> {
  i1.Order _object;
  _$OrderInsertable(this._object);
  @override
  Map<String, i0.Expression> toColumns(bool nullToAbsent) {
    return i2.OrderTableCompanion(
      ...
      orderNumber: i0.Value(_object.orderNumber),
      creditCardToken: i0.Value(_object.creditCardToken),
    ).toColumns(false);
  }
}

extension OrderToInsertable on i1.Order {
  _$OrderInsertable toInsertable() {
    return _$OrderInsertable(this);
  }
}
