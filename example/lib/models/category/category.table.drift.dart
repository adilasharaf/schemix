...
import 'package:example/models/category/category.dart' as i1;
import 'package:example/models/category/category.table.drift.dart' as i2;
import 'package:example/models/category/category.table.dart' as i3;
...
class $$CategoryTableTableFilterComposer
  ...
  i0.ColumnWithTypeConverterFilters<i1.CategoryType, i1.CategoryType, int>
...
class $$CategoryTableTableAnnotationComposer
  ...
  i0.GeneratedColumnWithTypeConverter<i1.CategoryType, int> get type =>
...
class $CategoryTableTable extends i3.CategoryTable
  ...
  @override
  late final i0.GeneratedColumnWithTypeConverter<i1.CategoryType, int> type =
  ...
  static i0.TypeConverter<i1.CategoryType, int> $convertertype =
...
class _$CategoryInsertable implements i0.Insertable<i1.Category> {
  i1.Category _object;
  _$CategoryInsertable(this._object);
  @override
  Map<String, i0.Expression> toColumns(bool nullToAbsent) {
    return i2.CategoryTableCompanion(
...
extension CategoryToInsertable on i1.Category {
  _$CategoryInsertable toInsertable() {
    return _$CategoryInsertable(this);
  }
}
