...
import 'package:example_infolder/models/profile/profile.dart' as i1;
import 'package:example_infolder/models/profile/profile.table.drift.dart' as i2;
import 'package:example_infolder/models/profile/profile.table.dart' as i3;
...
final class $$ProfileTableTableReferences
    extends
        i0.BaseReferences<
          ...
          .createAlias(
            i0.$_aliasNameGenerator(
              i7.ReadDatabaseContainer(
                db,
              ).resultSet<i2.$ProfileTableTable>('profiles').userId,
              i7.ReadDatabaseContainer(
                db,
...
class $$ProfileTableTableTableManager
    extends
        i0.RootTableManager<
          ...
          (i1.Profile, i2.$$ProfileTableTableReferences),
          i1.Profile,
        ...
        i0.TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  i2.$$ProfileTableTableReferences(db, table, e),
                ),
              )
              .toList(),
