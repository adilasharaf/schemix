...
import 'package:example/models/post/post.dart' as i1;
import 'package:example/models/post/post.table.drift.dart' as i2;
import 'package:example/models/post/post.table.dart' as i3;
...
class $$PostTableTableFilterComposer
  ...
  i0.ColumnWithTypeConverterFilters<i1.PostStatus, i1.PostStatus, int>
  ...
  i0.ColumnFilters<String> get categoryId => $composableBuilder(
...
class $$PostTableTableOrderingComposer
  ...
  i0.ColumnOrderings<String> get categoryId => $composableBuilder(
    column: $table.categoryId,
    builder: (column) => i0.ColumnOrderings(column),
  );
...
class $$PostTableTableAnnotationComposer
  ...
  i0.GeneratedColumnWithTypeConverter<i1.PostStatus, int> get status =>
      $composableBuilder(column: $table.status, builder: (column) => column);

  i0.GeneratedColumn<String> get userId =>
      $composableBuilder(column: $table.userId, builder: (column) => column);

  i0.GeneratedColumn<String> get categoryId => $composableBuilder(
    column: $table.categoryId,
...
class $PostTableTable extends i3.PostTable
  ...
  @override
  late final i0.GeneratedColumnWithTypeConverter<i1.PostStatus, int> status =
  ...
  static i0.TypeConverter<i1.PostStatus, int> $converterstatus =
...
class _$PostInsertable implements i0.Insertable<i1.Post> {
  i1.Post _object;
  _$PostInsertable(this._object);
  @override
  Map<String, i0.Expression> toColumns(bool nullToAbsent) {
    return i2.PostTableCompanion(
      id: i0.Value(_object.id),
      title: i0.Value(_object.title),
      body: i0.Value(_object.body),
      slug: i0.Value(_object.slug),
      status: i0.Value(_object.status),
      userId: i0.Value(_object.userId),
      categoryId: i0.Value(_object.categoryId),
    ).toColumns(false);
  }
}

extension PostToInsertable on i1.Post {
  _$PostInsertable toInsertable() {
    return _$PostInsertable(this);
  }
}
