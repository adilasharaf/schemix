...
import 'package:example_outfolder/models/tag/tag.dart' as i1;
import 'package:example_outfolder/models/tag/tag.table.drift.dart' as i2;
import 'package:example_outfolder/models/tag/tag.table.dart' as i3;
import 'package:uuid/uuid.dart' as i4;
import 'package:example_outfolder/models/post_tag/post_tag.table.drift.dart'
    as i5;
import 'package:drift/internal/modular.dart' as i6;
import 'package:example_outfolder/models/post_tag/post_tag.dart' as i7;
...
final class $$TagTableTableReferences
    extends i0.BaseReferences<i0.GeneratedDatabase, i2.$TagTableTable, i1.Tag> {
  $$TagTableTableReferences(super.$_db, super.$_table, super.$_typedResult);

  static i0.MultiTypedResultKey<i5.$PostTagTableTable, List<i7.PostTag>>
  _postTagTableRefsTable(i0.GeneratedDatabase db) =>
      i0.MultiTypedResultKey.fromTable(
        i6.ReadDatabaseContainer(
          db,
        ).resultSet<i5.$PostTagTableTable>('post_tags'),
        aliasName: i0.$_aliasNameGenerator(
          i6.ReadDatabaseContainer(db).resultSet<i2.$TagTableTable>('tags').id,
          i6.ReadDatabaseContainer(
            db,
          ).resultSet<i5.$PostTagTableTable>('post_tags').tagId,
        ),
      );

  i5.$$PostTagTableTableProcessedTableManager get postTagTableRefs {
    final manager = i5
...
class $$TagTableTableFilterComposer
  ...
  i0.Expression<bool> postTagTableRefs(
    i0.Expression<bool> Function(i5.$$PostTagTableTableFilterComposer f) f,
  ) {
    final i5.$$PostTagTableTableFilterComposer composer = $composerBuilder(
      composer: this,
      ...
      builder:
          ...
          }) => i5.$$PostTagTableTableFilterComposer(
            $db: $db,
...
class $$TagTableTableAnnotationComposer
  ...
  i0.Expression<T> postTagTableRefs<T extends Object>(
    i0.Expression<T> Function(i5.$$PostTagTableTableAnnotationComposer a) f,
  ) {
    final i5.$$PostTagTableTableAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: i6.ReadDatabaseContainer(
        $db,
      ...
      builder:
          (
            ...
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => i5.$$PostTagTableTableAnnotationComposer(
            $db: $db,
            $table: i6.ReadDatabaseContainer(
              $db,
            ).resultSet<i5.$PostTagTableTable>('post_tags'),
...
class $$TagTableTableTableManager
    extends
        i0.RootTableManager<
          ...
          (i1.Tag, i2.$$TagTableTableReferences),
          i1.Tag,
          i0.PrefetchHooks Function({bool postTagTableRefs})
        > {
        ...
        i0.TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  i2.$$TagTableTableReferences(db, table, e),
                ),
              )
              .toList(),
          prefetchHooksCallback: ({postTagTableRefs = false}) {
              ...
              getPrefetchedDataCallback: (items) async {
                return [
                  if (postTagTableRefs)
                    ...
                    >(
                      currentTable: table,
                      referencedTable: i2.$$TagTableTableReferences
