...
void main() {
  ...
  final missingFromWorkspace = foundPackages
      .where((p) => !workspacePaths.contains(p))
      .toList();

  final listedButMissingFromDisk = workspacePaths
      .where((p) => !foundPackages.contains(p))
      .toList();
