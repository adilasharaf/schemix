...
import 'package:example/models/product/product.dart' as i1;
import 'package:example/models/product/product.table.drift.dart' as i2;
import 'package:example/models/product/product.table.dart' as i3;
...
class _$ProductInsertable implements i0.Insertable<i1.Product> {
  i1.Product _object;
  ...
  Map<String, i0.Expression> toColumns(bool nullToAbsent) {
    return i2.ProductTableCompanion(
      ...
      price: i0.Value(_object.price),
      stock: i0.Value(_object.stock),
      type: i0.Value(_object.type),
    ).toColumns(false);
  }
}

extension ProductToInsertable on i1.Product {
